<?php
/**
 * GitHub Auto-Update for SNN Edu Utilities Plugin
 * 
...
$github_repo_name  = 'snn-edu-utilities';
$plugin_slug       = 'snn-edu-utilities';
$plugin_file       = 'snn-edu-utilities/snn-edu-utitilities.php';

/**
 * Check for Plugin Updates from GitHub
 */
add_filter('pre_set_site_transient_update_plugins', 'snn_edu_check_github_update');
function snn_edu_check_github_update($transient) {
 ...
 */
add_filter('plugins_api', 'snn_edu_plugin_info_from_github', 10, 3);
function snn_edu_plugin_info_from_github($result, $action, $args) {
    global $github_repo_owner, $github_repo_name, $plugin_slug, $plugin_file;
    ...
    $changelog = !empty($release_data->body) 
        ...
        : __('See GitHub release notes for details.', 'snn-edu-utilities');
    ...
    $result = (object) array(
        ...
        'sections'      => array(
            'description' => $plugin_data['Description'] ?? __('Educational utilities for WordPress.', 'snn-edu-utilities'),
 ...
 */
add_action('admin_footer', 'snn_edu_github_redirect_version_link');
function snn_edu_github_redirect_version_link() {
    ...
    <script type="text/javascript">
        (function() {
            ...
            const pluginSlug = 'snn-edu-utilities';
            ...
            function processLinks() {
                ...
                const links = document.querySelectorAll('.plugin-title a, .update-message a, a[aria-label*="SNN Edu Utilities"]');
